...
import { paymentRoute } from './routes/payment/paymants.routes';
// rate limiting
...
const limiter = rateLimit({
    ...
    max: 1250, // Define the maximum number of requests that each IP can make per window. Here it's set to 100.
